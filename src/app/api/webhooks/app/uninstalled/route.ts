...
import { handleDurableUninstall, verifyShopifyWebhookRequest, webhookErrorBody } from "@/lib/shopify/webhooks";
...
export async function POST(request: NextRequest) {
  ...
  return NextResponse.json(await handleDurableUninstall(String(body.myshopify_domain ?? body.shop_domain ?? "unknown")));
}
