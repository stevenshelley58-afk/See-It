/**
 * Integration test harness for the prepare route
 *
 * Tests the prepare route with various scenarios using the flow harness.
 * NOTE: This is a harness module, not a Vitest suite.
 */

import { runPrepareFlowForProduct } from "../flows/prepareFlow.harness";
...
export async function runAllPrepareRouteTests(
  ...
  const results = {
    valid: await testPrepareValidProduct(
      testShopId,
      testProductId,
      testImageUrl
