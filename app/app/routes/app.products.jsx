...
export const loader = async ({ request }) => {
    ...
    const logContext = createLogContext("system", requestId, "products-loader", {
        url: request.url,
    });
        ...
        for (const a of assets) {
            ...
            if (a.productId) {
                assetsMap[`gid://shopify/Product/${a.productId}`] = {
                    ...
                    // Legacy renderInstructions fields removed from schema
                    // Canonical fields: extractedFacts, merchantOverrides, resolvedFacts, placementSet
    ...
    try {
        ...
        logger.error({ ...logContext, stage: "error" }, "Products loader failed", topLevelError);
        const message = topLevelError instanceof Error ? topLevelError.message : "Unknown error";
        const enhancedError = new Error(`Products loader failed: ${message}`);
