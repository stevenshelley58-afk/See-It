...
async function handlePrepare(request, productIdFromRoute) {
    const requestId = getRequestId(request);
    let shopId = null;
    let productId = productIdFromRoute || null;
    let assetId = null;
...
// Spec path: /api/products/:id/prepare
export const action = async ({ request, params }) => {
    return handlePrepare(request, params.id);
};
